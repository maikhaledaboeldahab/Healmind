...
import { SESSION_STATUS_LABEL, SESSION_TYPE_LABEL } from '../../../features/admin/constants/statusEnums'
import { formatTime } from '../../../features/admin/utils/formatDate'
import styles from './AdminSessionCard.module.css'

function AdminSessionCard({ session, patientName, doctorName, onClick }) {
  return (
