...
const certifications = [
  { id: 1, name: "Board Certified Psychologist", issueDate: "March 2012", docId: "BCP-9920", fileUrl: "#" },
  { id: 2, name: "CBT Specialist Certification", issueDate: "June 2015", docId: "CBT-4412", fileUrl: "#" },
];
      ...
      <div className="row g-4">
        <div className="col-lg-8">
          ...
          <CertificationsList
            ...
            onAddNew={() => console.log("Add new certification clicked")}
          />
